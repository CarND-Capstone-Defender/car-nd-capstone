...
def create_tf_example(example):
    ...
    # Download from https://hci.iwr.uni-heidelberg.de/node/6132
    height = 720 # Image height of Bosch Images
    width = 1280 # Image width of Bosch Images
    ...
    image_format = 'png'.encode() # Bosch images are png
    ...
    for box in example['boxes']:
        ...
        classes.append(int(LABEL_DICT_14[box['label']]))
...
def main(_):
    ...
    writer = tf.python_io.TFRecordWriter(FLAGS.output_path + os.sep + "tf_train_bosch_data.record")
    
    # BOSCH dataset labeling file - here hardcoded.....
    INPUT_YAML = "bosch_train.yaml"
